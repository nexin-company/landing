...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const variantClasses = {
      ...
      glass:
        "bg-white/10 dark:bg-white/5 backdrop-blur-md border border-white/20 dark:border-white/10 text-foreground hover:bg-white/20 dark:hover:bg-white/10 shadow-[0_4px_30px_rgba(0,0,0,0.1)] active:scale-95",
      ghost: "hover:bg-muted/50 text-foreground transition-colors",
      unstyled: "",
    };
